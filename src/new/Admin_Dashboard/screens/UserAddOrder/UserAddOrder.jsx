...
const BasicDetailsForm = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await fetch('https://truckbackend-production.up.railway.app/api/create-orders', {
                method: 'POST',
                headers: {
    ...
    return (
        <div>
            {/* AppBar Component */}
            <AppBar position="static" color="default" style={{ margin: "20px", padding: "20px", boxShadow: 'none', borderBottom: '1px solid #ddd' }}>
            ...
            <Card style={{ margin: "20px", padding: "20px" }}>
                <CardContent>
                    <Typography variant="h5" gutterBottom>
                        <SvgIcon style={{ marginRight: "10px", verticalAlign: "middle" }}>
